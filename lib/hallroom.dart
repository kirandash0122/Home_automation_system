...
class MyHallPage extends StatefulWidget {
  MyHallPage(this.title,this.userName);

  final String title;
  final String userName;

  @override
  _MyHallPageState createState() => _MyHallPageState();
}
...
class _MyHallPageState extends State<MyHallPage> {
  ...
  void readLocal() async {
    mainReference.child(widget.userName).child('hallroom').onChildAdded.listen(_onEntryAdded);
    mainReference.child(widget.userName).child('hallroom')
        .onChildChanged
        ...
        IconButton(
          ...
          onPressed: () {
            Navigator.of(context).push(MaterialPageRoute(
                builder: (BuildContext context) => OptionsPage(room: "hallroom",userName: userName,)));
          },
        )
      ],
    );
